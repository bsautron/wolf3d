...
/*   Updated: 2015/03/31 06:59:19 by bsautron         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_make2(t_env *env, int i, char *line)
{
	size_t	j;
	size_t	k;
...
static void	ft_makemap(t_env *env, char *file, int fdex)
{
	int		fd;
	size_t	i;
	char	*line;
